    ...
    <div class="ms-login">
        <el-form :model="param" :rules="rules" ref="login" label-width="0px" class="ms-content">
          ...
          <el-form-item prop="college">
            <el-input v-model="param.college" placeholder="请输入大学"></el-input>
          </el-form-item>

          <el-form-item prop="degree">
            <el-input v-model="param.degree" placeholder="请输入学位"></el-input>
          </el-form-item>

          <el-form-item prop="office">
            <el-input v-model="param.office" placeholder="请输入科室"></el-input>
          </el-form-item>

          <el-form-item prop="leader">
            <el-input v-model="param.leader" placeholder="请输入直属上级"></el-input>
          </el-form-item>
    ...
    data: function() {
        return {
            ...
            rules: {
              ...
              college: [{ required: true, message: '请输入大学', trigger: 'blur' }],
              degree: [{ required: true, message: '请输入学位', trigger: 'blur' }],
              office: [{ required: true, message: '请输入科室', trigger: 'blur' }],
              leader: [{ required: true, message: '请输入直属上级', trigger: 'blur' }],
            },
        };
    },
    methods: {
        registerForm() {
          ...
          post_request.append('college', this.param.college)
          post_request.append('degree', this.param.degree)
          post_request.append('office', this.param.office)
          post_request.append('leader', this.param.leader)
          let _this = this;
          this.$http
          .request({
            url: this.$url + '/doctor/register',
            method: 'post',
            data: post_request,
          ...
          .then((response) => {
            ...
            if(response.data.register.retCode == 1){
              ...
              _this.$router.push('/SignInAsDoctor');
            }
            else {
              _this.$message({
